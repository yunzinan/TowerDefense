...
#include <memory>
#include "../../TowerDefense/gamewindow.h"
...
QT_MOC_LITERAL(3, 25, 8), // "winSinal"
QT_MOC_LITERAL(4, 34, 3) // "idx"

    },
    "GameWindow\0returnSignal\0\0winSinal\0idx"
};
...
void GameWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->winSinal((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWindow::returnSignal)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWindow::winSinal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GameWindow::returnSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void GameWindow::winSinal(int _t1)
{
