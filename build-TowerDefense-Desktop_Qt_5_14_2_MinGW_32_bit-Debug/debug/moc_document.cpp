...
#include <memory>
#include "../../TowerDefense/document.h"
...
QT_MOC_LITERAL(1, 9, 12), // "returnSignal"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "document\0returnSignal\0"
};
...
void document::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&document::returnSignal)) {
                *result = 0;
                return;
            }
        }
